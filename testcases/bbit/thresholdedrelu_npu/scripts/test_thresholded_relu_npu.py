...
data_type = 'float16'
GEN_ALPHA_LIST_PATH = 'csv_files/generated_alpha_fp16_1_12.csv'
RANGE_LIST_PATH = 'csv_files/designed_range_fp16_1_12.csv'
SHAPE_LIST_PATH = 'csv_files/designed_shape_fp16_1_12.csv'
