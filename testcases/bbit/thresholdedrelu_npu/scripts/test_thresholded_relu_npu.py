...
SHAPE_LIST_PATH = 'csv_files/designed_shape_fp16_linear_1_12.csv'
RANGE_LIST_PATH = 'csv_files/designed_range_fp16_linear_1_12.csv'
GEN_ALPHA_LIST_PATH = 'csv_files/generated_alpha_fp16_linear_1_12.csv'
...
# shape_list = my.generate_input_shape([1,10,20,50], [20,50,100,200], 4, 13)
#
